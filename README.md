...
| `case_mgmt.get`                                | [Get the case details using the case ID](https://automation.trendmicro.com/xdr/api-v3#tag/Case/paths/~1v3.0~1caseManagement~1cases~1%7Bid%7D/get)                                  |
