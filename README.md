...
| **Endpoint Security**                          |                                                                                                                                                                                                           |
| `endpoint.[list_security, consume_security]`   | [Get endpoint list](https://automation.trendmicro.com/xdr/api-v3#tag/Endpoint-Security/paths/~1v3.0~1endpointSecurity~1endpoints/get)                                                                     |
